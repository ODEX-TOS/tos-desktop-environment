...
1. Ensure you have read the [wiki](https://wiki.odex.be) especially the
   [style guide](https://wiki.odex.be/Developer/style-guide)
...
3. Update the README.md with details of changes to the interface, this includes
   ...
   parameters.
4. Increase the version numbers in the `version.txt` file and the README.md to
